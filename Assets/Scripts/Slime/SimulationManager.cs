...
namespace Slime
{
    public class SimulationManager : MonoBehaviour
    {
        ...
        [Header("Slime Settings")] [SerializeField]
        ...
        private void Start()
        {
            ...
            GraphicsUtility.createRenderTexture(ref foodMap, width, height, filterMode, graphicsFormat);
        ...
        private void setOnStart()
        {
            ...
            simulationShader.SetVector("foodColor", foodColor);
        }
        ...
        {
            Graphics.Blit(cameraCapture.resultMap, foodMap);
        }
